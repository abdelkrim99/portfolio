    ...
    <section className="hero">
      <div className="sections-container">
        <div className="left-section">
          ...
          <p>
            I am a recent Software Engineering graduate and aspiring Junior Web
            Developer with a keen focus on web development, specializing in
            familiar frameworks and technologies. Possessing a strong foundation
            in the field,
          </p>
          <div className="social">
            <a
              className="twitter icon-twitter"
              href="https://twitter.com/kimotgr"
              target="_blank"
            ></a>
            <a
